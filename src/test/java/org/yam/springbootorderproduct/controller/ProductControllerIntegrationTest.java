...
////                .andExpect(jsonPath("$.errors[0]").value("name: Name must be between 3 and 100 characters long"))
////                .andExpect(jsonPath("$.errors[1]").value("name: Name shouldn't be NULL or EMPTY"));
////    }
//
